...
local function setup_highlights()
  local hl = {
    ...
    if type(vim.api.nvim_set_hl) == 'function' then
      ...
      if style.fg then table.insert(cmd, 'guifg='..style.fg) end
      if style.bg then table.insert(cmd, 'guibg='..style.bg) end
      if style.sp then table.insert(cmd, 'guisp='..style.sp) end
      if style.bold then table.insert(cmd, 'gui=bold') end
      if style.italic then table.insert(cmd, 'gui=italic') end
      if style.undercurl then table.insert(cmd, 'guisp='..style.sp, 'gui=undercurl') end
